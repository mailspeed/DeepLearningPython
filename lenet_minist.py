...
# grab the MINIST dataset (if this is your first time using this
# dataset the the 55MB download may take a minute)
print("[INFO] accessing MNIST...")
#dataset = datasets.fetch_mldata("MINIST Original")
...
# scale the input data to the range [0, 1] and preform a train/test
# split
