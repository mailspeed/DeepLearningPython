...
# set a high recursion limit so the Teano doesn't complain
...
ap.add_argument("-s", "--start_epoch", type=int, default=10,
...
# if there is no specific model checkpoint supplied, then intialize
