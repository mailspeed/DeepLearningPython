...
# initialize the HDF5 dataset writer, then store the class labels
...
for i in np.arange(0, len(imagePaths), bs):
	...
	for (j, imagePath) in enumerate(batchPaths):
		...
		# (2) substracting the mean RGB pixel intensity from the
		# ImageNet dataset
	...
	# add the feature and labels to our HDF5 dataset
