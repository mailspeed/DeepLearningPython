...
# define the base path to where the ImageNet datasets
# devkit are stored on disk
BASE_PATH = "D:/DeeplearningPython/datasets/imagenet/ILSVRC2015"
...
# lists
MX_OUTPUT = "D:/datasets/imagenet"
TRAIN_MX_LIST = path.sep.join([MX_OUTPUT, "lists/train.lst"])
VAL_MX_LIST = path.sep.join([MODEL_PATH, "lists/val.lst"])
TEST_MX_LIST = path.sep.join([MODEL_PATH, "lists/test.lst"])
