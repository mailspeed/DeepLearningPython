...
def sigmoid_activation(x):
	# compute the sigmoid actviation value for a given input
...
def next_batch(X, y, batchSize):
	# loop over our dataset 'X' in mini-batches, yieldding a tuple of
...
# the data for training and remaining 50% for testing
