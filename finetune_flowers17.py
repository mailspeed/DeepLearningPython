...
# this may differ according to the system memory
batchSize = 32
...
# load the dataset from disk then scale the raw pixels intensities to
# the range [0, 1]
...
# will *not* be updating during the training process
